import { onMounted as e, watch as t, nextTick as o, onUnmounted as a, inject as l, computed as n, defineComponent as s, toRefs as r, ref as i, openBlock as u, createBlock as c, Teleport as d, createVNode as v, Transition as m, mergeProps as f, toHandlers as p, withCtx as y, withDirectives as M, createElementVNode as h, normalizeClass as b, normalizeStyle as g, withModifiers as D, renderSlot as w, vShow as C, createCommentVNode as E, readonly as L } from "vue";
...
var k = (() => ".vue-universal-modal-leave-from[data-v-5bc836f3],.vue-universal-modal-enter-to[data-v-5bc836f3]{opacity:1}.vue-universal-modal-enter-from[data-v-5bc836f3],.vue-universal-modal-leave-to[data-v-5bc836f3]{opacity:0}.vue-universal-modal[data-v-5bc836f3]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-5bc836f3]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-5bc836f3]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}\n")();
var _ = (e2, t2) => {
...
const $ = s({ inheritAttrs: false, props: { fullscreen: { type: Boolean, default: false }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  const { close: s2, disabled: u2, options: c2, modelValue: d2 } = r(e2);
  const v2 = i(d2.value === void 0 ? true : d2.value);
  const m2 = i(null);
  const f2 = i(!u2.value);
  const p2 = { transition: 300, closeClickDimmed: true, closeKeyCode: 27, styleModalContent: {}, ...c2.value };
  t([() => d2.value, () => u2.value], () => {
    const e3 = d2.value && !u2.value;
    f2.value = e3;
    if (d2.value)
      v2.value = d2.value;
  }, { immediate: true });
  const { latest: y2 } = A({ modalRef: m2, show: f2 });
  S({ latest: y2, modalRef: m2, show: f2 });
  ...
  const L2 = { beforeEnter: () => a2.emit("before-enter", m2.value), enter: () => a2.emit("enter", m2.value), afterEnter: () => {
    m2.value.querySelector(".modal").addEventListener("touchstart", D2, { passive: true });
    ...
    m2.value.querySelector(".modal").removeEventListener("touchstart", D2, { passive: true });
    m2.value.querySelector(".modal").removeEventListener("touchmove", C2, { passive: false });
  ...
  return { Log: _2, CLASS_NAME: q, emitClose: k2, inserted: v2, latest: y2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: M2, onMouseUpDimmed2: b2, touchModalStart: D2, touchModalMove: C2, touchModalEnd: E2, onTransitionEmit: L2, show: f2, teleportTarget: n2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
function x(e2, t2, o2, a2, l2, n2) {
  return e2.inserted ? (u(), c(d, { key: 0, to: e2.teleportTarget, disabled: e2.disabled }, [v(m, f({ appear: "", name: e2.CLASS_NAME }, p(e2.onTransitionEmit)), { default: y(() => {
    var _a;
    return [M(h("div", f({ ref: "modalRef", role: "dialog", tabindex: "-1", "aria-modal": "true", "aria-label": "Modal window", class: [e2.CLASS_NAME, { [`${e2.CLASS_NAME}-show`]: e2.show }, { [`${e2.CLASS_NAME}-latest`]: e2.latest }], style: { transitionDuration: e2.transition } }, e2.$attrs), [h("div", { class: b(`${e2.CLASS_NAME}-content`), style: g({ transitionDuration: e2.transition, ...(_a = e2.mergeOptions) == null ? void 0 : _a.styleModalContent }), onMousedown: t2[0] || (t2[0] = D((...t3) => e2.onMouseDownDimmed && e2.onMouseDownDimmed(...t3), ["self"])), onMouseup: t2[1] || (t2[1] = D((...t3) => e2.onMouseUpDimmed2 && e2.onMouseUpDimmed2(...t3), ["self"])), onTouchmove: t2[2] || (t2[2] = D((t3) => e2.close(), ["self"])) }, [w(e2.$slots, "default", { emitClose: e2.emitClose }, void 0, true), w(e2.$slots, "close", {}, void 0, true)], 38)], 16), [[C, e2.show]])];
  }), _: 3 }, 16, ["name"])], 8, ["to", "disabled"])) : E("", true);
}
var R = _($, [["render", x], ["__scopeId", "data-v-5bc836f3"]]);
