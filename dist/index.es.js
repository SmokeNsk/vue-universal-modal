import { onMounted as e, watch as t, nextTick as o, onUnmounted as a, inject as l, computed as n, defineComponent as s, toRefs as r, ref as i, openBlock as u, createBlock as d, Teleport as v, createVNode as c, Transition as m, mergeProps as f, toHandlers as p, withCtx as b, withDirectives as g, createElementVNode as h, normalizeClass as y, normalizeStyle as M, withModifiers as w, renderSlot as D, vShow as C, createCommentVNode as E, readonly as L } from "vue";
...
var T = (() => ".vue-universal-modal-leave-from[data-v-5116b679],.vue-universal-modal-enter-to[data-v-5116b679]{opacity:1}.vue-universal-modal-enter-from[data-v-5116b679],.vue-universal-modal-leave-to[data-v-5116b679]{opacity:0}.vue-universal-modal[data-v-5116b679]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-5116b679]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-5116b679]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}.modal[data-v-5116b679]{position:fixed;width:100%;bottom:0;box-sizing:border-box;font-size:20px;text-align:center;background:var(--ion-item-background, var(--ion-background-color, #fff));border-radius:10px 10px 0 0/10px 10px 0px 0px;overflow:hidden}.start-modal[data-v-5116b679],.vue-universal-modal-enter-to .modal[data-v-5116b679],.vue-universal-modal-leave-from .modal[data-v-5116b679]{transition-timing-function:cubic-bezier(.11,.93,.28,1);transition-property:transform;transition-duration:.3s;transform:translateZ(0)}.vue-universal-modal-enter-from .modal[data-v-5116b679],.vue-universal-modal-leave-to .modal[data-v-5116b679]{transition-timing-function:cubic-bezier(.74,0,.23,1);transition-property:transform;transition-duration:.3s;transform:translate3d(0,100%,0)!important}\n")();
var A = (e2, t2) => {
...
const _ = s({ inheritAttrs: false, props: { fullscreen: { type: Boolean, default: false }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  const { onMouseDownDimmed: g2, onMouseUpDimmed: h2 } = x({ close: s2, closeClickDimmed: p2.closeClickDimmed, closeKeyCode: p2.closeKeyCode, latest: b2 });
  const y2 = (e3) => {
    h2(e3);
    if (s2.value)
      s2.value();
  ...
  return { Log: A2, CLASS_NAME: q, emitClose: T2, inserted: c2, latest: b2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: g2, onMouseUpDimmed2: y2, touchModalStart: w2, touchModalMove: C2, touchModalEnd: E2, onTransitionEmit: L2, show: f2, teleportTarget: n2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
function $(e2, t2, o2, a2, l2, n2) {
  return e2.inserted ? (u(), d(v, { key: 0, to: e2.teleportTarget, disabled: e2.disabled }, [c(m, f({ appear: "", name: e2.CLASS_NAME }, p(e2.onTransitionEmit)), { default: b(() => {
    var _a;
    return [g(h("div", f({ ref: "modalRef", role: "dialog", tabindex: "-1", "aria-modal": "true", "aria-label": "Modal window", class: [e2.CLASS_NAME, { [`${e2.CLASS_NAME}-show`]: e2.show }, { [`${e2.CLASS_NAME}-latest`]: e2.latest }], style: { transitionDuration: e2.transition } }, e2.$attrs), [h("div", { class: y(`${e2.CLASS_NAME}-content`), style: M({ transitionDuration: e2.transition, ...(_a = e2.mergeOptions) == null ? void 0 : _a.styleModalContent }), onMousedown: t2[0] || (t2[0] = w((...t3) => e2.onMouseDownDimmed && e2.onMouseDownDimmed(...t3), ["self"])), onMouseup: t2[1] || (t2[1] = w((...t3) => e2.onMouseUpDimmed2 && e2.onMouseUpDimmed2(...t3), ["self"])), onTouchmove: t2[2] || (t2[2] = w((t3) => e2.close(), ["self"])) }, [h("div", { class: "modal modal-sheet", style: M({ height: e2.fullscreen ? "100%" : "unset" }) }, [D(e2.$slots, "default", { emitClose: e2.emitClose }, void 0, true), D(e2.$slots, "close", {}, void 0, true)], 4)], 38)], 16), [[C, e2.show]])];
  }), _: 3 }, 16, ["name"])], 8, ["to", "disabled"])) : E("", true);
}
var R = A(_, [["render", $], ["__scopeId", "data-v-5116b679"]]);
