import { onMounted as e, watch as t, nextTick as a, onUnmounted as o, inject as n, computed as l, defineComponent as s, toRefs as i, ref as r, openBlock as u, createBlock as d, Teleport as v, createVNode as c, Transition as m, mergeProps as f, toHandlers as p, withCtx as y, withDirectives as h, createElementVNode as g, normalizeClass as b, normalizeStyle as M, withModifiers as w, renderSlot as C, vShow as D, createCommentVNode as x, readonly as E } from "vue";
...
var T = (() => ".vue-universal-modal-leave-from[data-v-6e7ae4d7],.vue-universal-modal-enter-to[data-v-6e7ae4d7]{opacity:1}.vue-universal-modal-enter-from[data-v-6e7ae4d7],.vue-universal-modal-leave-to[data-v-6e7ae4d7]{opacity:.3}.vue-universal-modal[data-v-6e7ae4d7]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-6e7ae4d7]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-6e7ae4d7]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}.modal[data-v-6e7ae4d7]{position:fixed;width:100%;bottom:0;box-sizing:border-box;font-size:20px;text-align:center;background:var(--ion-item-background, var(--ion-background-color, #fff));border-radius:10px 10px 0 0/10px 10px 0px 0px;overflow:hidden;height:var(--maxHeight, unset);will-change:transform,opacity}.start-modal[data-v-6e7ae4d7],.vue-universal-modal-enter-to .modal[data-v-6e7ae4d7],.vue-universal-modal-leave-from .modal[data-v-6e7ae4d7]{transition-timing-function:cubic-bezier(.11,.93,.28,1);transition-property:transform;transition-duration:.3s;transform:translateZ(0)}.vue-universal-modal-enter-from .modal[data-v-6e7ae4d7],.vue-universal-modal-leave-to .modal[data-v-6e7ae4d7]{transition-timing-function:cubic-bezier(.74,0,.23,1);transition-property:transform;transition-duration:.3s;transform:translate3d(0,100%,0)!important}\n")();
var A = (e2, t2) => {
...
var N = A(_, [["render", $], ["__scopeId", "data-v-6e7ae4d7"]]);
