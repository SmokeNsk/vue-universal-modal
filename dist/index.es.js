import { onMounted as e, watch as t, nextTick as o, onUnmounted as a, inject as n, computed as l, defineComponent as s, toRefs as i, ref as r, openBlock as d, createBlock as u, Teleport as v, createVNode as c, Transition as m, mergeProps as f, toHandlers as p, withCtx as y, withDirectives as h, createElementVNode as g, normalizeClass as b, normalizeStyle as M, withModifiers as w, renderSlot as C, vShow as D, createCommentVNode as x, readonly as E } from "vue";
...
var T = (() => ".vue-universal-modal-leave-from[data-v-d374dd64],.vue-universal-modal-enter-to[data-v-d374dd64]{opacity:1}.vue-universal-modal-enter-from[data-v-d374dd64],.vue-universal-modal-leave-to[data-v-d374dd64]{opacity:0}.vue-universal-modal[data-v-d374dd64]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-d374dd64]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-d374dd64]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}.modal[data-v-d374dd64]{position:fixed;width:100%;bottom:0;box-sizing:border-box;font-size:20px;text-align:center;background:var(--ion-item-background, var(--ion-background-color, #fff));border-radius:10px 10px 0 0/10px 10px 0px 0px;overflow:hidden;height:var(--maxHeight, unset)}.start-modal[data-v-d374dd64],.vue-universal-modal-enter-to .modal[data-v-d374dd64],.vue-universal-modal-leave-from .modal[data-v-d374dd64]{transition-timing-function:cubic-bezier(.11,.93,.28,1);transition-property:transform;transition-duration:.3s;transform:translateZ(0)}.vue-universal-modal-enter-from .modal[data-v-d374dd64],.vue-universal-modal-leave-to .modal[data-v-d374dd64]{transition-timing-function:cubic-bezier(.74,0,.23,1);transition-property:transform;transition-duration:.3s;transform:translate3d(0,100%,0)!important}\n")();
var A = (e2, t2) => {
...
const _ = s({ inheritAttrs: false, props: { initialBreakpoint: { type: Number, default: void 0 }, breakpoints: { type: Array, default: [] }, swipe: { type: Boolean, default: true }, swipeToClose: { type: Number, default: 0 }, close: { type: Function, default: () => {
  ...
  const { close: s2, disabled: d2, options: u2, modelValue: v2 } = i(e2);
...
function $(e2, t2, o2, a2, n2, l2) {
  return e2.inserted ? (d(), u(v, { key: 0, to: e2.teleportTarget, disabled: e2.disabled }, [c(m, f({ appear: "", name: e2.CLASS_NAME }, p(e2.onTransitionEmit)), { default: y(() => {
    var _a;
...
var N = A(_, [["render", $], ["__scopeId", "data-v-d374dd64"]]);
