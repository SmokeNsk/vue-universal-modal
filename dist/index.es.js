...
const x = s({ inheritAttrs: false, props: { close: { type: Function, default: () => {
  ...
  const { onMouseDownDimmed: g2, onMouseUpDimmed: M2 } = S({ close: n2, closeClickDimmed: f2.closeClickDimmed, closeKeyCode: f2.closeKeyCode, latest: p2 });
  ...
  return { Log: D2, CLASS_NAME: N, emitClose: b2, inserted: v2, latest: p2, mergeOptions: f2, modalRef: c2, onMouseDownDimmed: g2, onMouseUpDimmed: M2, onTransitionEmit: C2, show: m2, teleportTarget: l2, transition: f2.transition ? f2.transition / 1e3 + "s" : void 0 };
} });
...
const U = (e2, t2 = {}) => {
  ...
  e2.provide(V, { teleportTarget: o2, visibleModals: E(s2), addVisibleModals: i2, removeVisibleModals: u2 });
  e2.component(n2, T);
};
var K = { install: U };
export { N as CLASS_NAME, V as PLUGIN_NAME, K as default };
