...
var N = (() => ".vue-universal-modal-leave-from[data-v-25879b19],.vue-universal-modal-enter-to[data-v-25879b19]{opacity:1}.vue-universal-modal-enter-from[data-v-25879b19],.vue-universal-modal-leave-to[data-v-25879b19]{opacity:0}.vue-universal-modal[data-v-25879b19]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-25879b19]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-25879b19]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}\n")();
var T = (e2, t2) => {
...
const _ = s({ inheritAttrs: false, props: { fullscreen: { type: Boolean, default: false }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  const g2 = { beforeEnter: () => l2.emit("before-enter", m2.value), enter: () => l2.emit("enter", m2.value), afterEnter: () => l2.emit("after-enter", { targetRef: m2, close: e2.close }), enterCancelled: () => l2.emit("enter-cancelled", m2.value), beforeLeave: () => l2.emit("before-leave", m2.value), leave: () => l2.emit("leave", m2.value), afterLeave: () => {
  ...
  return { Log: D2, CLASS_NAME: R, emitClose: C2, inserted: v2, latest: M2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: h2, onMouseUpDimmed2: b2, touchModalStart: E2, touchModalMove: N2, touchModalEnd: T2, onTransitionEmit: g2, show: f2, teleportTarget: n2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
