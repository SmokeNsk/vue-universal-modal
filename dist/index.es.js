...
function T(e2, t2, o2, l2, a2, n2) {
  ...
  }), _: 3 }, 16, ["name"])], 8, ["to", "disabled"])) : (u(), h("div", R, "k"));
}
var V = $(x, [["render", T]]);
...
const K = (e2, t2 = {}) => {
  ...
  e2.provide(N, { teleportTarget: o2, visibleModals: k(a2), addVisibleModals: n2, removeVisibleModals: s2 });
  e2.component(l2, V);
};
var O = { install: K };
