...
const A = ({ modalRef: e2, show: a2 }) => {
  const { visibleModals: s2, addVisibleModals: r2, removeVisibleModals: i2 } = l(R);
  const u2 = n(() => {
...
var k = (() => ".vue-universal-modal-leave-from[data-v-f95f2fb0],.vue-universal-modal-enter-to[data-v-f95f2fb0]{opacity:1}.vue-universal-modal-enter-from[data-v-f95f2fb0],.vue-universal-modal-leave-to[data-v-f95f2fb0]{opacity:0}.vue-universal-modal[data-v-f95f2fb0]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-f95f2fb0]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-f95f2fb0]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}\n")();
var _ = (e2, t2) => {
...
const $ = s({ inheritAttrs: false, props: { fullscreen: { type: Boolean, default: false }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  L({ latest: y2, modalRef: f2, show: m2 });
  ...
  const S2 = { beforeEnter: () => a2.emit("before-enter", f2.value), enter: () => a2.emit("enter", f2.value), afterEnter: () => {
    f2.value.querySelector(".modal").addEventListener("touchstart", D2, { passive: true });
    f2.value.querySelector(".modal").addEventListener("touchmove", C2, { passive: true });
    f2.value.querySelector(".modal").addEventListener("touchmove", E2, { passive: true });
    ...
    f2.value.querySelector(".modal").removeEventListener("touchstart", D2, { passive: true });
    f2.value.querySelector(".modal").removeEventListener("touchmove", C2, { passive: true });
    f2.value.querySelector(".modal").removeEventListener("touchmove", E2, { passive: true });
  ...
  return { Log: _2, CLASS_NAME: V, emitClose: k2, inserted: c2, latest: y2, mergeOptions: p2, modalRef: f2, onMouseDownDimmed: M2, onMouseUpDimmed2: b2, touchModalStart: D2, touchModalMove: C2, touchModalEnd: E2, onTransitionEmit: S2, show: m2, teleportTarget: n2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
...
const q = (e2, t2 = {}) => {
  ...
  e2.provide(R, { teleportTarget: o2, visibleModals: S(l2), addVisibleModals: n2, removeVisibleModals: s2 });
  e2.component(a2, N);
};
var U = { install: q };
