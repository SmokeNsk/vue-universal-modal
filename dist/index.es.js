...
var T = (() => ".vue-universal-modal-leave-from[data-v-10007f1d],.vue-universal-modal-enter-to[data-v-10007f1d]{opacity:1}.vue-universal-modal-enter-from[data-v-10007f1d],.vue-universal-modal-leave-to[data-v-10007f1d]{opacity:0}.vue-universal-modal[data-v-10007f1d]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-10007f1d]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-10007f1d]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}.modal[data-v-10007f1d]{position:fixed;width:100%;bottom:0;box-sizing:border-box;font-size:20px;text-align:center;background:var(--ion-item-background, var(--ion-background-color, #fff));border-radius:10px 10px 0 0/10px 10px 0px 0px;overflow:hidden;height:var(--maxHeight, unset)}.start-modal[data-v-10007f1d],.vue-universal-modal-enter-to .modal[data-v-10007f1d],.vue-universal-modal-leave-from .modal[data-v-10007f1d]{transition-timing-function:cubic-bezier(.11,.93,.28,1);transition-property:transform;transition-duration:.3s;transform:translateZ(0)}.vue-universal-modal-enter-from .modal[data-v-10007f1d],.vue-universal-modal-leave-to .modal[data-v-10007f1d]{transition-timing-function:cubic-bezier(.74,0,.23,1);transition-property:transform;transition-duration:.3s;transform:translate3d(0,100%,0)!important}\n")();
var A = (e2, t2) => {
  ...
  const x2 = (t2) => {
    ...
    if (a3 != 0) {
      ...
      if (e2.swipeToClose && e2.swipeToClose <= l3) {
        t2.currentTarget.style.transitionDuration = `50ms`;
        if (s2.value)
          s2.value();
        return;
      } else
...
var N = A(_, [["render", $], ["__scopeId", "data-v-10007f1d"]]);
