import { onMounted as e, watch as t, nextTick as o, onUnmounted as a, inject as n, computed as l, defineComponent as r, toRefs as i, ref as s, openBlock as u, createBlock as d, Teleport as v, createVNode as c, Transition as m, mergeProps as f, toHandlers as p, withCtx as b, withDirectives as h, createElementVNode as g, normalizeClass as y, normalizeStyle as M, withModifiers as w, renderSlot as D, vShow as C, createCommentVNode as x, readonly as E } from "vue";
const L = ({ modalRef: n2, latest: l2, show: r2 }) => {
  let i2;
  function s2(e2) {
...
const S = ({ close: t2, closeClickDimmed: o2, closeKeyCode: n2, latest: l2 }) => {
  ...
  return { onMouseDownDimmed: i2, onMouseUpDimmed: s2 };
};
const k = ({ modalRef: e2, show: a2 }) => {
  const { visibleModals: r2, addVisibleModals: i2, removeVisibleModals: s2 } = n(R);
  const u2 = l(() => {
...
var A = (() => ".vue-universal-modal-leave-from[data-v-93b297f4],.vue-universal-modal-enter-to[data-v-93b297f4]{opacity:1}.vue-universal-modal-enter-from[data-v-93b297f4],.vue-universal-modal-leave-to[data-v-93b297f4]{opacity:0}.vue-universal-modal[data-v-93b297f4]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-93b297f4]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-93b297f4]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}.modal[data-v-93b297f4]{position:fixed;width:100%;bottom:0;box-sizing:border-box;font-size:20px;text-align:center;background:var(--ion-item-background, var(--ion-background-color, #fff));border-radius:10px 10px 0 0/10px 10px 0px 0px;overflow:hidden;height:var(--maxHeight, unset)}.start-modal[data-v-93b297f4],.vue-universal-modal-enter-to .modal[data-v-93b297f4],.vue-universal-modal-leave-from .modal[data-v-93b297f4]{transition-timing-function:cubic-bezier(.11,.93,.28,1);transition-property:transform;transition-duration:.3s;transform:translateZ(0)}.vue-universal-modal-enter-from .modal[data-v-93b297f4],.vue-universal-modal-leave-to .modal[data-v-93b297f4]{transition-timing-function:cubic-bezier(.74,0,.23,1);transition-property:transform;transition-duration:.3s;transform:translate3d(0,100%,0)!important}\n")();
var T = (e2, t2) => {
...
const _ = r({ inheritAttrs: false, props: { initialBreakpoint: { type: Number, default: void 0 }, breakpoints: { type: Array, default: [] }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  const { close: r2, disabled: u2, options: d2, modelValue: v2 } = i(e2);
  ...
  L({ latest: b2, modalRef: m2, show: f2 });
  const { onMouseDownDimmed: h2, onMouseUpDimmed: g2 } = S({ close: r2, closeClickDimmed: p2.closeClickDimmed, closeKeyCode: p2.closeKeyCode, latest: b2 });
  const y2 = (e3) => {
    g2(e3);
    if (r2.value)
      r2.value();
  ...
  return { Log: T2, CLASS_NAME: V, emitClose: A2, inserted: c2, latest: b2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: h2, onMouseUpDimmed2: y2, touchModalStart: w2, touchModalMove: C2, touchModalEnd: x2, onTransitionEmit: E2, show: f2, teleportTarget: l2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
...
const q = (e2, t2 = {}) => {
  ...
  e2.provide(R, { teleportTarget: o2, visibleModals: E(n2), addVisibleModals: l2, removeVisibleModals: r2 });
  e2.component(a2, N);
};
var B = { install: q };
