import { onMounted as e, watch as t, nextTick as a, onUnmounted as o, inject as n, computed as l, defineComponent as s, toRefs as i, ref as r, openBlock as u, createBlock as d, Teleport as c, createVNode as v, Transition as m, mergeProps as f, toHandlers as p, withCtx as y, withDirectives as h, createElementVNode as g, normalizeClass as b, normalizeStyle as M, withModifiers as w, renderSlot as C, vShow as D, createCommentVNode as x, readonly as E } from "vue";
...
const S = ({ close: t2, closeClickDimmed: a2, closeKeyCode: n2, latest: l2 }) => {
  let s2 = null;
  function i2(e2) {
    s2 = e2.target;
  }
...
var T = (() => ".vue-universal-modal-leave-from[data-v-679ca612],.vue-universal-modal-enter-to[data-v-679ca612]{opacity:1}.vue-universal-modal-enter-from[data-v-679ca612],.vue-universal-modal-leave-to[data-v-679ca612]{opacity:0}.vue-universal-modal[data-v-679ca612]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-679ca612]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-679ca612]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}.modal[data-v-679ca612]{position:fixed;width:100%;bottom:0;box-sizing:border-box;font-size:20px;text-align:center;background:var(--ion-item-background, var(--ion-background-color, #fff));border-radius:10px 10px 0 0/10px 10px 0px 0px;overflow:hidden;height:var(--maxHeight, unset);will-change:transform,opacity}.start-modal[data-v-679ca612],.vue-universal-modal-enter-to .modal[data-v-679ca612],.vue-universal-modal-leave-from .modal[data-v-679ca612]{transition-timing-function:cubic-bezier(.11,.93,.28,1);transition-property:transform;transition-duration:.3s;transform:translateZ(0)}.vue-universal-modal-enter-from .modal[data-v-679ca612],.vue-universal-modal-leave-to .modal[data-v-679ca612]{transition-timing-function:cubic-bezier(.74,0,.23,1);transition-property:transform;transition-duration:.3s;transform:translate3d(0,100%,0)!important}\n")();
var A = (e2, t2) => {
...
const _ = s({ inheritAttrs: false, props: { initialBreakpoint: { type: Number, default: void 0 }, breakpoints: { type: Array, default: [] }, swipe: { type: Boolean, default: true }, swipeToClose: { type: Number, default: 0 }, close: { type: Function, default: () => {
  ...
  const x2 = (t2) => {
    const o3 = t2.changedTouches[0].clientY - M2.sy;
    if (o3 != 0) {
      const n2 = t2.currentTarget.getBoundingClientRect().height;
      const l3 = Math.abs(o3) / n2;
      if (e2.swipeToClose && e2.swipeToClose <= l3) {
  ...
  const E2 = { beforeEnter: () => o2.emit("before-enter", m2.value), enter: () => o2.emit("enter", m2.value), afterEnter: () => {
    if (e2.swipe) {
  ...
  return { Log: A2, CLASS_NAME: B, emitClose: T2, inserted: v2, latest: y2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: h2, onMouseUpDimmed2: b2, touchModalStart: w2, touchModalMove: D2, touchModalEnd: x2, onTransitionEmit: E2, show: f2, teleportTarget: l2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
function $(e2, t2, a2, o2, n2, l2) {
...
var N = A(_, [["render", $], ["__scopeId", "data-v-679ca612"]]);
...
const V = (e2, t2 = {}) => {
  ...
  e2.provide(R, { teleportTarget: a2, visibleModals: E(n2), addVisibleModals: l2, removeVisibleModals: s2 });
  e2.component(o2, N);
};
var q = { install: V };
