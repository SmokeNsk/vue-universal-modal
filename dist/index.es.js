...
var k = (() => ".vue-universal-modal-leave-from[data-v-4d51b3d6],.vue-universal-modal-enter-to[data-v-4d51b3d6]{opacity:1}.vue-universal-modal-enter-from[data-v-4d51b3d6],.vue-universal-modal-leave-to[data-v-4d51b3d6]{opacity:0}.vue-universal-modal[data-v-4d51b3d6]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-4d51b3d6]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-4d51b3d6]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}\n")();
var _ = (e2, t2) => {
...
const $ = s({ inheritAttrs: false, props: { fullscreen: { type: Boolean, default: false }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  return { Log: _2, CLASS_NAME: q, emitClose: k2, inserted: c2, latest: y2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: M2, onMouseUpDimmed2: b2, touchModalStart: D2, touchModalMove: C2, touchModalEnd: E2, onTransitionEmit: L2, show: f2, teleportTarget: n2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
...
var R = _($, [["render", x], ["__scopeId", "data-v-4d51b3d6"]]);
