...
var k = (() => ".vue-universal-modal-leave-from[data-v-f2149caa],.vue-universal-modal-enter-to[data-v-f2149caa]{opacity:1}.vue-universal-modal-enter-from[data-v-f2149caa],.vue-universal-modal-leave-to[data-v-f2149caa]{opacity:0}.vue-universal-modal[data-v-f2149caa]{-webkit-overflow-scrolling:touch;overscroll-behavior:contain;position:fixed;overflow-y:auto;left:0;top:0;right:0;bottom:0;background-color:#000c;text-align:left}.vue-universal-modal[data-v-f2149caa]:not(.vue-universal-modal-latest){z-index:1000}.vue-universal-modal-content[data-v-f2149caa]{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;min-height:100%}\n")();
var _ = (e2, t2) => {
...
const $ = s({ inheritAttrs: false, props: { fullscreen: { type: Boolean, default: false }, swipe: { type: Boolean, default: true }, close: { type: Function, default: () => {
  ...
  const L2 = { beforeEnter: () => a2.emit("before-enter", m2.value), enter: () => a2.emit("enter", m2.value), afterEnter: () => {
    m2.value.querySelector(".modal").addEventListener("touchstart", b2, { passive: true });
    ...
    m2.value.querySelector(".modal").removeEventListener("touchstart", b2, { passive: true });
  ...
  return { Log: _2, CLASS_NAME: q, emitClose: k2, inserted: v2, latest: y2, mergeOptions: p2, modalRef: m2, onMouseDownDimmed: M2, onMouseUpDimmed2: g2, touchModalStart: b2, touchModalMove: C2, touchModalEnd: E2, onTransitionEmit: L2, show: f2, teleportTarget: n2, transition: p2.transition ? p2.transition / 1e3 + "s" : void 0 };
} });
...
var R = _($, [["render", x], ["__scopeId", "data-v-f2149caa"]]);
